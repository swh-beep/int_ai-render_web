    ...
    return [
        ...
        },
        {
            ...
            "prompt": (
                ...
                "LEFT refers to the physical camera-body location, not the side of the room that dominates the frame. "
                "Use a clear lateral translation of roughly 12-18% of the visible room width plus a 15-25 degree yaw. "
                "Nearby furniture should shift toward screen-RIGHT relative to the far background.\n"
                ...
                "SCENE PRESERVATION: Preserve furniture identities, room architecture, lighting direction, relative placement, and world-space orientation.\n"
        ...
        },
        {
            ...
            "prompt": (
                ...
                "RIGHT refers to the physical camera-body location, not the side of the room that dominates the frame. "
                "Use a clear lateral translation of roughly 12-18% of the visible room width plus a 15-25 degree yaw. "
                "Nearby furniture should shift toward screen-LEFT relative to the far background.\n"
                "VIEWPOINT REQUIRED: The view must show real parallax, changed occlusions, and newly visible side planes caused by camera movement.\n"
                "SCENE PRESERVATION: Preserve furniture identities, room architecture, lighting direction, relative placement, and world-space orientation.\n"
