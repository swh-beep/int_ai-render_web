...
def test_call_gemini_with_failover_forwards_explicit_image_ratio_size_and_thinking_config(monkeypatch):
    captured = {}
    _install_fake_genai_client(monkeypatch, captured)
    ...
    assert captured["config"]["image_config"]["image_size"] == "4K"
